...
function M.create_keybinds()
  local keybinds = {}
  keybinds = utils.merge_lists(keybinds, M.default_keybinds)
  keybinds = utils.merge_lists(keybinds, M.tmux_keybinds)
  keybinds = utils.merge_lists(keybinds, M.user_keybinds)
  return keybinds
end
