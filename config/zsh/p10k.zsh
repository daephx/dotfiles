# Generated by Powerlevel10k configuration wizard on 2021-03-13 at 15:44 PST.
...
() {
  ...
  # Styling for HOME.
    ...
    typeset -g POWERLEVEL9K_DIR_HOME_FOREGROUND=227
    typeset -g POWERLEVEL9K_DIR_HOME_SHORTENED_FOREGROUND=103
    typeset -g POWERLEVEL9K_DIR_HOME_ANCHOR_FOREGROUND=39

  # Styling for CONIG.
    # typeset -g POWERLEVEL9K_DIR_CONIG_VISUAL_IDENTIFIER_EXPANSION=''
    typeset -g POWERLEVEL9K_DIR_CONIG_FOREGROUND=8
    typeset -g POWERLEVEL9K_DIR_CONIG_SHORTENED_FOREGROUND=103
    typeset -g POWERLEVEL9K_DIR_CONIG_ANCHOR_FOREGROUND=39
