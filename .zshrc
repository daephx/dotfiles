...
export ZSH="/home/daemonphoenix42/.config/oh-my-zsh/"
...
function precmd() {
  if [ $timer ]; then
    ...
    export RPROMPT="[%F{darkgray}${timer_show}s] %{$reset_color%}"
    unset timer
  fi
}
...
alias cls="clear"
alias dotconfig="/usr/bin/git --git-dir=$HOME/.config/.git/ --work-tree=$HOME"
